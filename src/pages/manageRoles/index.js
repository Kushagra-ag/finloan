...
export default function ManageRoles() {
	...
	const addNewRole = () => {
		...
		if(unique) { 
			addRoles(roles => ([...roles, {role: newRole.name, desc: newRole.desc, checked: false}]))
			setNewRole({
				name: '',
				desc: ''
			})
            ...
            <div className="py-3 d-flex align-items-center">
                ...
                <div>
                    <div
                        ...
                        data-toggle="modal" data-target="#addnewrole"
                    >
	                    ...
	                    <div className="white-card d-flex align-items-center justify-content-between">
	                    	...
	                    	<div className="align-self-start">
	                    		<div className="custom-control custom-switch">
								  <input type="checkbox" defaultChecked={role.checked} className="custom-control-input" id={role.role} />
