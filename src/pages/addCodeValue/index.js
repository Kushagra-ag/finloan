  ...
  return (
      ...
      <div className="white-card row w-100">
	      	...
	      	<div className="row">
	      		<div className="col-sm-4">
	      			<div className="form-group">
	      				<label className="form-label font-weight-500" htmlFor="codeValue">
	      					Code value
	      				</label>
	      				<input type="text" id="codeValue" className="form-control h-50px" />
	      			</div>
	      		</div>
	      		<div className="col-sm-4">
	      			<div className="form-group">
	      ...
	      <div className="row">
	      	<div className="col-sm-4">
	      		<div className="form-group">
	      			<label className="form-label font-weight-500" htmlFor="status">
	      				Status
	      			</label>
	      			<select id="status" className="custom-select h-50px">
	      ...
	      <div className="row">
	      	<div className="col-12 d-flex justify-content-end mb-5">
	      		...
	      		<div className="green-btn">
	      			<img src={Plus} className="mr-2 align-bottom" alt="" />
	      			Add
	      		</div>
