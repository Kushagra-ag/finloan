      ...
      <div className="row w-100">
        <div className="col-sm-6 col-lg-4 my-3">
          <div className="white-card d-flex align-items-center justify-content-start">
            ...
            <div>
              ...
              <p className="mb-0">Add new extra fields to any entity in the form of data table</p>
            </div>
        ...
        <div className="col-sm-6 col-lg-4 my-3">
          <div className="white-card d-flex align-items-center justify-content-start">
            ...
            <div>
              <h6>Audit Trails</h6>
              <p className="mb-0">Audit logs of all the activities, such as create client, disburse loans etc</p>
            </div>
        ...
        <div className="col-sm-6 col-lg-4 my-3">
          <div className="white-card d-flex align-items-center justify-content-start">
            ...
            <div>
              ...
              <p className="mb-0">Define or modify roles and associated permissions</p>
            </div>
        ...
        <div className="col-sm-6 col-lg-4 my-3">
          <div className="white-card d-flex align-items-center justify-content-start">
            ...
            <div>
              ...
              <p className="mb-0">Preferences for generating account numbers for client, loan and savings accounts</p>
            </div>
        ...
        <div className="col-sm-6 col-lg-4 my-3">
          <div className="white-card d-flex align-items-center justify-content-start">
            ...
            <div>
              ...
              <p className="mb-0">Two-factor authentication configuration settings</p>
            </div>
